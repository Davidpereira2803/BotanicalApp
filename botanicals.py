...
class BotanicalApp:
    ...
    def open_dilution_calculator(self):
        dilution_window = tk.Toplevel(self.master)
        dilution_window.title("Alcohol Dilution Calculator")

        # Labels and entry fields for user input
        initial_concentration_label = tk.Label(dilution_window, text="Initial Alcohol Concentration (%):")
        initial_concentration_label.grid(row=0, column=0, pady=10, padx=10, sticky=tk.E)

        initial_concentration_entry = tk.Entry(dilution_window)
        initial_concentration_entry.grid(row=0, column=1, pady=10, padx=10)

        initial_volume_label = tk.Label(dilution_window, text="Initial Solution Volume (ml):")
        initial_volume_label.grid(row=1, column=0, pady=10, padx=10, sticky=tk.E)

        initial_volume_entry = tk.Entry(dilution_window)
        initial_volume_entry.grid(row=1, column=1, pady=10, padx=10)

        target_concentration_label = tk.Label(dilution_window, text="Target Alcohol Concentration (%):")
        target_concentration_label.grid(row=2, column=0, pady=10, padx=10, sticky=tk.E)

        target_concentration_entry = tk.Entry(dilution_window)
        target_concentration_entry.grid(row=2, column=1, pady=10, padx=10)

        # Label to display the result
        result_label = tk.Label(dilution_window, text="")
        ...
        calculate_button = tk.Button(dilution_window, text="Calculate", command=calculate_dilution)
